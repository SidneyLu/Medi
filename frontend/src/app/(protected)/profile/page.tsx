...
export default function ProfilePage() {
  ...
  const form = useForm<FormInput, undefined, FormValues>({ resolver: zodResolver(schema), defaultValues: { nickname: "", birth_date: "", sex_at_birth: "unknown", pregnancy_status: "not_applicable", chronic_conditions: "", allergies: "", current_medications: "" } });
